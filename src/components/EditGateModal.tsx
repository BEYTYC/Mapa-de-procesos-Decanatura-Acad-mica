...
import { FlowGateData } from '../types';

interface EditGateModalProps {
  isOpen: boolean;
  onClose: () => void;
  gateType: 'entrada' | 'salida';
  initialData: FlowGateData;
  onSave: (updatedData: FlowGateData) => void;
}

export const EditGateModal: React.FC<EditGateModalProps> = ({
  isOpen,
  onClose,
  gateType,
  initialData,
  ...
  const [formData, setFormData] = useState<FlowGateData>(initialData);
  ...
  const isEntrada = gateType === 'entrada';
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="font-extrabold text-base leading-tight">
                  Editar Caja: {isEntrada ? "ENTRADA" : "SALIDA"}
                </h3>
                <span className="text-xs text-slate-300">
                  Modifique los textos institucionales de este bloque
                </span>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="ej. ORIGEN o DESTINO FINAL"
                  required
                />
              </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-slate-50 border border-slate-300 rounded-xl text-xs font-bold text-[#0A1F3C] focus:outline-none focus:border-[#0A1F3C]"
                placeholder="ej. Aspirantes o Egresados ENAP"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Descripción del grupo o destino..."
                required
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-slate-50 border border-slate-300 rounded-xl text-xs font-bold text-[#0A1F3C] focus:outline-none focus:border-[#0A1F3C]"
                placeholder="ej. Punto de Inicio o Proceso Completo"
                required
              />
            </div>
